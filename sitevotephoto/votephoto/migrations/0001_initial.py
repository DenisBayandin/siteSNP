# Generated by Django 4.0.1 on 2022-12-20 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_145x165', models.ImageField(blank=True, upload_to='photos_145x165/%Y/%m/%d', verbose_name='Фотография размером 145x165')),
                ('photo_510x510', models.ImageField(blank=True, upload_to='photos_510x510/%Y/%m/%d', verbose_name='Фотография размером 510x510')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votephoto.photo', verbose_name='Пост, который содержит лайк')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Поставил лайк')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('contentComment', models.TextField(verbose_name='Комментарий')),
                ...
                ('photo_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votephoto.photo')),

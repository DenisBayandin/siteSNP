...
def celery_delete_photo():
    # TODO Функция проверяющая текущую дату и дату удаления, если текущая дата >= даты удаления удаляем фотографию.
    """
...
def delete_photo(request, photoID):
    ...
    """
        ...
        Отпрвляем увдомление, о том, что комментарий будет удалён, так как фотография отправлена на удаление.
    """

...
class UserAdmin(admin.ModelAdmin):
    list_display = ('username', 'last_name', 'first_name', 'email', 'date_create', 'date_update')
    ...
    search_fields = ('username__icontains', 'first_name__icontains', 'last_name__icontains', 'email__icontains',
                     'date_create__icontains', 'date_update__icontains')
    fields = ('username',
              'last_name',
              'first_name',
              'patronymic',
...
class PhotoAdmin(admin.ModelAdmin):
    list_display = ('name', 'content', 'state', 'info_published', 'modification', 'date_create', 'date_update')
    list_display_links = ('name', 'content')
    list_filter = ('info_published', 'modification', 'state')
    search_fields = ('name__icontains', 'username__icontains', 'date_create__icontains', 'date_update__icontains')

...
class Photo(models.Model):
    ...
    info_published = models.BooleanField(
        default=False,
        verbose_name='To publish?'
    )
    modification = models.BooleanField(default=False)
    photo_delete = models.ImageField(
        blank=True,
        null=True,
        upload_to='delete_photos/%Y/%m/%d'
    )
    new_photo = models.ImageField(
        blank=False,
        upload_to='new_photos/%Y/%m/%d'
    )
    old_photo = models.ImageField(
        blank=True,
        upload_to='old_photos/%Y/%m/%d'
    )
    photo_145x165 = models.ImageField(
        blank=True,
        upload_to='photos_145x165/%Y/%m/%d'
    )
    photo_510x510 = models.ImageField(
        blank=True,
